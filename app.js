...
const hitModules = [
  lesson(1, "爆款定义与完整经营模型", "能区分短期销量款与可持续核心单品，并讲清爆款形成条件。", "亚马逊爆款不是单纯销量高，而是在核心需求下持续获得流量、稳定转化、利润和库存可控，并能沉淀自然排名的核心商品。", ["需求真实：目标关键词有稳定搜索需求。", "供给有优势：产品、价格或体验至少一项形成差异。", "转化闭环：Listing、Review、价格和履约共同降低决策阻力。", "经营可持续：广告、利润、库存与售后能够长期承接。"], ["销量与销售额", "访问量与Listing转化率", "广告销售占比与TACOS", "自然关键词排名", "贡献利润与库存可售天数"], ["先定义目标市场和核心词。", "拆解竞品流量、转化与Review门槛。", "建立产品、Listing、广告、库存闭环。", "按周判断继续、优化或停止。"], "只看销量或类目排名；把大额广告等同于打造爆款；忽略毛利和库存；用短期低价订单判断长期需求。", "我理解的爆款不是短期冲高销量，而是一个商品在核心关键词下形成稳定曝光和转化，同时广告、利润、Review与库存都能承接。判断是否成功，要看自然排名、转化率、TACOS和贡献利润能否逐步进入稳定区间。", "我会把爆款看成一个经营模型。前端是市场需求和关键词，中间是产品、价格、Listing与Review形成转化，后端是广告、库存和利润承接。起盘阶段可以用广告获取数据和订单，但不能长期只靠亏损投放。真正进入稳定期后，核心词自然排名、自然订单占比和Review资产应该持续改善，同时补货节奏和售后风险可控。"),
  ...
  lesson(3, "关键词研究与搜索需求", "能识别关键词角色，并把词库用于Listing和广告投放。", "关键词是买家需求的文字表达。关键词研究不是找流量最大的词，而是找到与产品高度相关、能够带来成交的搜索意图。", ["核心词承接品类需求，决定主战场。", "属性词说明规格、功能和适配条件。", "场景词和痛点词更接近真实使用需求。", "竞品词用于商品投放或防守，不应硬塞进Listing。"], ["搜索量与搜索趋势", "关键词相关性", "广告点击率", "广告转化率", "搜索词订单量", "自然关键词排名"], ["收集品牌分析、广告搜索词和竞品词。", "按核心词、属性词、场景词、问题词和竞品词分组。", "把高相关词布局到标题、五点描述、详情页和后台词。", "通过广告验证点击和成交质量。"], "把搜索量等同于购买意图；标题重复堆词；把低相关大词当核心词；只看投放词，不看买家真实搜索词。", "关键词研究不是找流量最大的词，而是找到与产品高度相关、能够成交的搜索意图。我会先分核心词、属性词和场景词，再通过广告搜索词报告验证点击率、转化率和订单质量。", "我会先建立词库，再安排关键词在Listing和广告中的角色。核心高相关词进入标题和精准投放；属性词和场景词进入五点描述、详情页和词组投放；自动和广泛投放负责拓词。判断一个词是否值得加预算，不只看曝光，还要看相关性、点击率、转化率、订单量和自然排名。最终目标不是词表好看，而是让关键词带来稳定流量和订单。"),
  lesson(4, "竞品与Review拆解", "能从竞品表现倒推买家决策和我方突破口。", "竞品拆解不是照抄Listing，而是找出对手为什么被点击、为什么成交、为什么被差评。", ["主图和价格影响点击。", "卖点、Review和履约影响转化。", "好评说明买家购买理由。", "差评暴露产品和表达机会。"], ["价格与优惠", "评分、Review数量和近期Review速度", "主图信息密度", "核心词位置", "差评主题频率"], ["选择主竞品和参考竞品。", "建立竞品快照。", "按点击、转化、信任和履约拆解。", "统计好评和差评。", "形成追平、差异化和不可复制清单。"], "只看头部；把Review多当成唯一壁垒；复制文案；忽略近期差评。", "我拆竞品不照抄Listing，而是看它为什么被点击、为什么成交、为什么被差评。最后把信息分成必须追平、可以差异化和必须回到产品解决的三类。", "我会先选头部竞品看门槛，再选参考竞品看切入机会。点击层看主图、价格和优惠；转化层看卖点、Review、规格和履约；Review层重点统计好评中的购买理由和差评中的高频问题。最后输出追平项、差异化项和产品缺陷项，避免把产品问题误当成Listing问题。"),
  ...
  lesson(6, "利润、盈亏平衡ACOS与预算", "能计算盈亏平衡ACOS，并理解ACOS与TACOS的分工。", "广告是否可接受，要看贡献利润和阶段目标，不能用统一ACOS标准处理所有商品。", ["单件广告前利润等于售价减产品、物流、配送、佣金和其他成本。", "盈亏平衡ACOS等于单件广告前利润除以售价。", "ACOS看广告效率。", "TACOS看整体广告依赖。"], ["毛利和贡献利润", "ACOS", "TACOS", "广告订单占比", "每单广告成本", "退款后真实利润"], ["确认完整成本。", "按商品和站点计算盈亏平衡ACOS。", "设定起盘期预算和期限。", "按周观察自然订单变化。"], "认为ACOS越低越好；混用币种；忽略退款、优惠和仓储；用广告销售额代替总销售额。", "我不会只看ACOS高低。ACOS看单次投放效率，盈亏平衡ACOS看是否亏损，TACOS看整体是否依赖广告，三者要结合商品阶段和贡献利润判断。", "我先算清售价扣除产品、物流、配送、佣金和其他成本后的广告前利润，再得出盈亏平衡ACOS。起盘期允许部分核心词投入偏高，但要设预算、周期和自然增长目标；成熟期更看重真实利润和TACOS。每周还要把退款、优惠和仓储放回利润表，避免账面盈利。"),
  lesson(7, "Listing内容与转化逻辑", "能按买家决策顺序设计Listing。", "Listing的任务是让正确买家理解产品、确认适配、相信承诺并购买。", ["主图影响点击。", "标题说明品类、属性和适配。", "五点描述讲利益、证据和风险。", "详情页用场景和对比完成说服。"], ["点击率", "Listing转化率", "退货率", "问答和客服高频问题", "版本转化差异"], ["用关键词和Review确定信息优先级。", "首屏讲清产品、适合谁和核心优势。", "明确规格、兼容性和限制。", "一次只测试一个变量。"], "只追关键词密度；夸大性能；隐藏兼容限制；一次改多个内容。", "Listing不是堆信息，而是按买家决策顺序降低顾虑：主图先争取点击，标题说明相关性，五点和详情页讲清价值与限制，Review提供信任。", "我会先用关键词和Review确定买家最关心什么，再把首屏信息集中在产品是什么、适合谁、有什么优势。主图负责点击，标题负责品类和适配，五点描述补充利益、证据和限制，详情页用场景和对比降低理解成本。优化后只改一个变量，并用点击率、转化率、退货和客服问题验证。"),
